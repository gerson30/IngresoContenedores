...
public class daoUsuario {
    ...
    //login recibe dos valores que es usuario y contraseña
    //se declara usuario y contraseña
    public int login(String u, String p){
        ...
        if(cr!=null&&cr.moveToFirst()){
            do{
                //si encuentra al menos un usuario significa que si existe en la base de datos a=1 si no encuentra a=0
    ...
    //retornar usuario para iniciar sesión
